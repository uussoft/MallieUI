...
namespace Mallie.UI
{
    ...
    public static class FontImageHelper
    {
        ...
        {
            AwesomeFont = new FontImages(ReadFontFileFromResource("Mallie.UI.Font.FontAwesome.ttf"));
            ElegantFont = new FontImages(ReadFontFileFromResource("Mallie.UI.Font.ElegantIcons.ttf"));
        }
