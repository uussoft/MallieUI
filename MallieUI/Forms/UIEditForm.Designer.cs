namespace Mallie.UI
{
    partial class UIEditForm
    {
        ...
        {
            this.pnlBtm = new Mallie.UI.UIPanel();
            this.btnCancel = new Mallie.UI.UISymbolButton();
            this.btnOK = new Mallie.UI.UISymbolButton();
            ...
            this.pnlBtm.RadiusSides = Mallie.UI.UICornerRadiusSides.None;
