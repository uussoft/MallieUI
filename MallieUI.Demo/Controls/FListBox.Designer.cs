namespace Mallie.UI.Demo
{
    partial class FListBox
    {
        ...
        {
            this.uiImageListBox1 = new Mallie.UI.UIImageListBox();
            this.uiLine1 = new Mallie.UI.UILine();
            this.uiLine2 = new Mallie.UI.UILine();
            this.uiListBox1 = new Mallie.UI.UIListBox();
            ...
            this.uiCheckBox1.ValueChanged += new Mallie.UI.UICheckBox.OnValueChanged(this.uiCheckBox1_ValueChanged);
            // 
            // FListBox
            // 
